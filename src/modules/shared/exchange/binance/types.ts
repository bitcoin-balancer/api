...
type ICoinTicker = {
  ...
  openTime: number; // the timestamp of the beginning of the ticker e.g. 1724331055499
  closeTime: number; // the time at which the ticket will close     e.g. 1724417455499
