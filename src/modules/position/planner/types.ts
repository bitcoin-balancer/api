...
/**
 * Increase Plan
 * The plan that will be used to open/increase a position when the price drops significantly and a
 ...
 *                                         MODULE EXPORTS                                         *
 ************************************************************************************************ */
export type { ITargetState, IIncreasePlan, IDecreaseLevels, IDecreasePlan, IPositionPlan };
